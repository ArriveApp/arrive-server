...
User.create(email: "harry@test.com",      password: "test", password_confirmation: "test", pin: 'harr', firstname: "Harry", lastname: "Potter", is_teacher: false, is_admin: false, school_id: hogwarts.id)
