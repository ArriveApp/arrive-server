...
describe ArriveServer::UniquePinGenerator do
  describe '#next' do
    it 'returns a pin of the correct length' do
      pin_generator = ArriveServer::UniquePinGenerator.new([], 4)
    ...
    it 'does not return a pin that has already been used' do
      pin_generator = ArriveServer::UniquePinGenerator.new(['1234', '5678'], 4)
